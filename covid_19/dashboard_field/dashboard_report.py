...
class DashboardReport(DashboardChart):
    ...
    def show_configuration(self):
        ...
        str1 = str1 +" Il "+self.fornisci_data(self.dati)+" sono stati effettuati "+str(int(self.dati.tamponi_test_molecolare))+" tamponi molecolari e "+str(int(self.dati.tamponi_test_antigenico_rapido)) + " test antigenici rapidi"
        str1 = str1 + " riportando un tasso di positività pari al "+str(100.0*float(self.dati.tasso_positivi_tamponi))+"%."
